...
const AuthorCard: React.FC<AuthorCardProps> = ({ author, onUpdate }) => {
  ...
  const handleUpdate = async (e: React.FormEvent) => {
    ...
    try {
      await axios.put(`/api/authors/${author.id}`, formData)
    ...
    <>
      <div className="bg-white rounded-lg shadow-md overflow-hidden border border-gray-200 hover:shadow-lg transition-shadow">
        <div className="p-5">
          ...
          <p className="text-gray-600 mb-4 line-clamp-3">{author.biography}</p>
      ...
      {isEditModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
            <div className="p-6">
              <h3 className="text-xl font-bold text-gray-800 mb-4">Modifier l'auteur</h3>
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-6">
                Êtes-vous sûr de vouloir supprimer l'auteur <span className="font-semibold">{author.name}</span> ?
